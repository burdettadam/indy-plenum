...
def test_fill_ts_store_for_config_after_catchup(txnPoolNodeSet,
    ...
    sdk_send_txn_author_agreement(looper, pool_handle, vdr_wallet_trustee, *create_random_taa(),
    ...
    disconnect_node_and_ensure_disconnected(looper,
                                            ...
                                            node_to_disconnect)
    looper.removeProdable(name=node_to_disconnect.name)
    sdk_reply = sdk_send_txn_author_agreement(looper, pool_handle, vdr_wallet_trustee, *create_random_taa(),
                                              ratified=get_utc_epoch() - 600)
