...
def test_reconnect_primary_and_not_primary(looper,
    ...
    vdr_send_random_and_check(looper, txnPoolNodeSet, pool_handle, vdr_wallet_steward, 5)
    ...
    vdr_send_random_and_check(looper, restNodes, pool_handle, vdr_wallet_steward, 5)
