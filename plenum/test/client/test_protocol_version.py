...
def test_request_none_protocol_version(looper, txnPoolNodeSet,
    ...
    with pytest.raises(VdrError) as e:
        vdr_signed_random_requests(looper, wallet_client, request_num, protocol_version=None)
...
def test_request_with_outdated_version(looper,
    ...
    with pytest.raises(VdrError) as e:
        vdr_signed_random_requests(looper, wallet_client, request_num, protocol_version=CURRENT_PROTOCOL_VERSION - 1)
...
def test_request_with_invalid_version(looper,
    ...
    signed_objects = vdr_signed_random_requests(looper, wallet_client, request_num)
...
def test_request_with_correct_version(looper,
    ...
    signed_reqs = vdr_sign_request_objects(looper, wallet_client, reqs_obj)
