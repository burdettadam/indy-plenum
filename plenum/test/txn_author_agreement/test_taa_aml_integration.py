...
def test_taa_acceptance_writes(looper, taa_aml_request, pool_handle, vdr_wallet_trustee):
    req = vdr_sign_and_send_prepared_request(looper, vdr_wallet_trustee, pool_handle, taa_aml_request)
    vdr_get_and_check_replies(looper, [req])


def test_taa_acceptance_writes_module_static(looper, taa_aml_request, pool_handle, vdr_wallet_trustee):
...
def test_taa_acceptance_writes_module_dynamic(looper, taa_aml_request, pool_handle, vdr_wallet_trustee):
    req = vdr_sign_and_send_prepared_request(looper, vdr_wallet_trustee, pool_handle, taa_aml_request)
    vdr_get_and_check_replies(looper, [req])
...
def test_taa_aml_optional_description(looper, taa_aml_request, pool_handle, vdr_wallet_trustee):
    taa_aml_request = json.loads(taa_aml_request)
