...
def test_ordering_after_more_than_f_nodes_caught_up(
        chkFreqPatched, looper, txnPoolNodeSet, pool_handle, vdr_wallet_steward,
    ...
    for _ in range(2):
        add_new_node(looper, txnPoolNodeSet, pool_handle, vdr_wallet_steward,
                     tdir, tconf, allPluginsPath)
    checkViewNoForNodes(txnPoolNodeSet, initial_view_no)

    vdr_send_random_and_check(looper, txnPoolNodeSet,
                              pool_handle, vdr_wallet_steward, 20)
