...
def test_request_older_than_stable_checkpoint_removed(chkFreqPatched, looper, txnPoolNodeSet, pool_handle,
    ...
    vdr_send_random_and_check(looper, txnPoolNodeSet, pool_handle, vdr_wallet_steward, 2 * max_batch_size)
    ...
    vdr_send_random_and_check(looper, txnPoolNodeSet, pool_handle, vdr_wallet_steward, max_batch_size)
    ...
    vdr_send_random_and_check(looper, txnPoolNodeSet, pool_handle, vdr_wallet_steward, reqs_for_checkpoint + 1)
