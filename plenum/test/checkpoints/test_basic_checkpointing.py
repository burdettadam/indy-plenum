...
def test_old_checkpoint_deleted(tconf, looper, txnPoolNodeSet, pool_handle, wallet_client, reqs_for_checkpoint):
    """
    ...
    vdr_send_random_and_check(looper, txnPoolNodeSet, pool_handle, wallet_client, 2 * reqs_for_checkpoint)
