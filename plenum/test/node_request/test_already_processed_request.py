...
def test_already_processed_requests(looper, txnPoolNodeSet,
    ...
    reqs = vdr_signed_random_requests(looper, wallet_client, 1)
    ...
    request1 = vdr_get_replies(looper, reqs, timeout=total_timeout)
    ...
    request2 = vdr_send_random_and_check(looper, txnPoolNodeSet, pool_handle, wallet_client, 1)
    ...
    request3 = vdr_send_signed_requests(pool_handle, reqs, looper)
